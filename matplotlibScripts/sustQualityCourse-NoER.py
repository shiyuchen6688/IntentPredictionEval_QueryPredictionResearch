...
if __name__ == "__main__":
    ...
    fscore = [0.94912929, 0.92403655] 
    precision = [0.95130559, 0.9997572] 
    recall = [0.94846261, 0.92274875]
    Types = 2
    ...
    ax.set_title('Effect of Experience Replay\nFragment Prediction Quality (Course Website)', fontsize=22)
    ax.set_xticks(r1+barwidth)
    ax.set_xticklabels(('QL-ExpReplay', 'QL-NoExpReplay'), fontsize=20)
    #ax.set_yscale('log')
    ax.set_ylim(0.0, 1.1)
    #plt.ylabel('log-scale',fontsize=20)
    #plt.yticks(np.arange(0.92, 0.97, 0.02),fontsize=20)
