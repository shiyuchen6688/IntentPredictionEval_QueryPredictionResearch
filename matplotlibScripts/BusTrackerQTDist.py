...
if __name__ == "__main__":
    with open('BusTrackerQTDist.csv') as f:
        lines = f.readlines()
        header = lines[0]
    ...
    plt.plot(cols[tokens[4]], cols[tokens[0]], 'm', linewidth = 4, marker = '^', markevery=2, markersize = 16, label= '#DELETE')
    plt.plot(cols[tokens[4]], cols[tokens[1]], 'r', linewidth = 4, marker = '*', markevery=2, markersize = 16, label= '#INSERT')
    plt.plot(cols[tokens[4]], cols[tokens[2]], 'g', linewidth = 4, marker = 'o', markevery=2, markersize = 16, label= '#SELECT')
    plt.plot(cols[tokens[4]], cols[tokens[3]], 'b', linewidth = 4, marker = 'v', markevery=2, markersize = 16, label= '#UPDATE')
    ...
    #plt.savefig('BusTrackerQTDist.png')
    plt.show()
