...
if __name__ == "__main__":
    ...
    lstm_score = [0.796741461, 0.194356073] 
    gru_score = [0.704975968, 0.204681592]
    Types = 2
    ...
    fig, ax = plt.subplots()
    rects1 = ax.bar(r1, fscore, color='deepskyblue', width = barwidth, edgecolor='black', label='RNN-Synth', hatch='*') 
    rects2 = ax.bar(r2, precision, color='lawngreen', width = barwidth, edgecolor='black', label='LSTM-Synth', hatch = 'O') 
    rects3 = ax.bar(r3, recall, color='lightcoral', width = barwidth, edgecolor='black', label='GRU-Synth', hatch='x') 

    ax.set_title('Effect of Session Context\nFragment Quality(Course Website)', fontsize=28)
