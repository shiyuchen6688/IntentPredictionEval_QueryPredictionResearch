...
if __name__ == "__main__":
    ...
    trainT = [43725.2505, 46438.9098, 44940.6606] 
    testT = [7525.05977, 8865.12606, 8548.02869] 
    Types = 3
    ...
    ax.set_title('Train & Test Times (secs)\n of RNN Variants (Course Website)', fontsize=28)
    ax.set_xticks(r1+barwidth)
    ax.set_xticklabels(('RNN-Synth', 'LSTM-Synth', 'GRU-Synth'), fontsize=24)
    #ax.set_yscale('log')
    ...
    fig.tight_layout()
    #plt.savefig('sustTimeRNNCourse.eps')
    plt.show()
