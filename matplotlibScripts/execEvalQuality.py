...
if __name__ == "__main__":
    ...
    totF1 = [0.864, 0.729, 0.289, 0.047, 0.0006] 
    tupF1 = [0.847, 0.710 , 0.288, 0.0459, 0.0] 
    colF1 = [0.932, 0.802, 0.293, 0.0509, 0.003]
    Types = 5
    ...
    ax.set_title('Query Execution - Avg Quality Measures\n (Course Website)', fontsize=22)
