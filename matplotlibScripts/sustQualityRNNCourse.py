...
if __name__ == "__main__":
    ...
    fscore = [0.81029961, 0.79674146, 0.70497597] 
    precision = [0.83157192, 0.82445626, 0.72974975] 
    recall = [0.80713637, 0.78949516, 0.70296173]
    Types = 3
    ...
    ax.set_title('Quality of RNN Variants\n (Course Website)', fontsize=42)
    ax.set_xticks(r1+barwidth)
    ax.set_xticklabels(('RNN-Synth', 'LSTM-Synth', 'GRU-Synth'), fontsize=28)
    #ax.set_yscale('log')
    ax.set_ylim(0.0, 1.1)
    ...
    fig.tight_layout()
    #plt.savefig('sustQualityRNNCourse.eps')
    plt.show()
