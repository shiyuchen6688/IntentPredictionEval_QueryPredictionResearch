...
if __name__ == "__main__":
    ...
    fscore = [0.986, 0.943, 0.859, 0.841, 0.849] 
    precision = [0.986, 0.943, 0.859, 0.841, 0.849] 
    recall = [0.986, 0.943, 0.859, 0.841, 0.849] 
    Types = 5
    ...
    fig.tight_layout()
    #plt.savefig('sustQueryTypeBT.eps')
    plt.show()
