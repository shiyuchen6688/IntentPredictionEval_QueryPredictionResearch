...
if __name__ == "__main__":
    ...
    ax.set_title('F1-Score Distribution for Precision!=Recall\n(Course Website, log-scale)', fontsize=18)
    ax.set_xticks(r1+2*barwidth)
    ax.set_xticklabels(('[0.0,0.1]', '(0.1,0.2]', '(0.2,0.3]', '(0.3,0.4]', '(0.4,0.5]', '(0.5,0.6]', '(0.6,0.7]', '(0.7,0.8]', '(0.8,0.9]', '(0.9,1.0)'), fontsize=25)
    ax.set_yscale('log')
    ax.set_ylim(1e-1, 1e4)
    plt.ylabel('#Queries',fontsize=20)
    #plt.yticks(np.arange(0, 1.1, 0.2),fontsize=25)
    ax.tick_params(labelsize=16)
    ax.legend(bbox_to_anchor=(0.5,-0.05), loc='upper center', ncol=5, prop={'size':14})
