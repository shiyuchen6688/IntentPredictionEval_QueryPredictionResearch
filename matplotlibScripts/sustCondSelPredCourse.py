...
if __name__ == "__main__":
    ...
    fscore = [0.976, 0.897, 0.768, 0.46, 0.012] 
    precision = [0.974, 0.913, 0.807, 0.592, 0.012] 
    recall = [0.98, 0.885, 0.739, 0.396, 0.012] 
    Types = 5
    ...
    ax.set_title('Conditional Selection\n(WHERE | Tables, Course Website)', fontsize=22)
    ...
    fig.tight_layout()
    #plt.savefig('sustTablesCourse.eps')
    plt.show()
