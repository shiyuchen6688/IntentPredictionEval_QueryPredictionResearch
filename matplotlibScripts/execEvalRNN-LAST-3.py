...
if __name__ == "__main__":
    ...
    fig, ax = plt.subplots()
    rects1 = ax.bar(r1, RNNF1, color='deepskyblue', width = barwidth, edgecolor='black', label='RNN-S', hatch='*') 
    rects2 = ax.bar(r2, LSTMF1, color='lawngreen', width = barwidth, edgecolor='black', label='LSTM-S', hatch = 'O') 
    rects3 = ax.bar(r3, GRUF1, color='lightcoral', width = barwidth, edgecolor='black', label='GRU-S', hatch='x') 
