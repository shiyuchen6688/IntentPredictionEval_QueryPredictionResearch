...
if __name__ == "__main__":
    ...
    fscore = [0.92192, 0.61894, 0.430329, 0.078, 0.30843] 
    precision = [0.922764, 0.668148, 0.446509, 0.077953, 0.30843] 
    recall = [0.921812, 0.610772, 0.520064, 0.08768, 0.30843] 
    Types = 5
    ...
    ax.set_title('Projected Column List\n(Bus Tracker)', fontsize=22)
