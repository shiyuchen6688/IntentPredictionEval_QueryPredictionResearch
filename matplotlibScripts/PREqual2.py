...
if __name__ == "__main__":
    ...
    PRAbsDiff = [0.0036, 0.046, 0.065, 0.077, 0.128] 
    Types = 5
    barwidth = 1.0/(Types+2)
    
    r1 = np.arange(len(PRAbsDiff))
    fig, ax = plt.subplots()
    rects1 = ax.bar(r1, PRAbsDiff, color='deepskyblue', width = barwidth, edgecolor='black') 

    ax.set_title('Avg |Precision-Recall|\n (Course Website)', fontsize=22)
