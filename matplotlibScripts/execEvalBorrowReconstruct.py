...
if __name__ == "__main__":
    ...
    borrowF1 = [0.864, 0.729, 0.289, 0.047, 0.0006] 
    reconstF1 = [0.456, 0.409, 0.251, 0.023, 0.0006] 
    Types = 5
    ...
    fig, ax = plt.subplots()
    rects1 = ax.bar(r1, borrowF1, color='deepskyblue', width = barwidth, edgecolor='black', label='F1(Borrow)', hatch='*') 
    rects2 = ax.bar(r2, reconstF1, color='lightcoral', width = barwidth, edgecolor='black', label='F1(Reconstruct)', hatch='x') 

    ax.set_title('Query Execution - Borrow vs. Reconstruct\n (Course Website)', fontsize=22)
