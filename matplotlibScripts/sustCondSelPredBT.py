...
if __name__ == "__main__":
    ...
    fscore = [0.962, 0.842, 0.733, 0.662, 0.668] 
    precision = [0.962, 0.862, 0.771, 0.662, 0.668] 
    recall = [0.962, 0.828, 0.713, 0.662, 0.668] 
    Types = 5
    ...
    ax.set_title('Conditional Selection\n(WHERE | Tables, Bus Tracker)', fontsize=22)
