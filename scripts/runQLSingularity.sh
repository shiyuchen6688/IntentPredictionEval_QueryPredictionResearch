#!/bin/sh
python QLearning_selOpConst.py -config configDir/MINC_QL_singularity_configFile.txt
python CreateSQLLogs.py -config configDir/MINC_QL_singularity_configFile.txt
