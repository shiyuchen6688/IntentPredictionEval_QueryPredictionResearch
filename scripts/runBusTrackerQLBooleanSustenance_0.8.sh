#!/bin/sh
python QLearning_selOpConst.py -config configDir/BusTracker_QL_BOOLEAN_trainTest_sustenance_0.8_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_QL_BOOLEAN_trainTest_sustenance_0.8_configFile.txt
#python QLearning_selOpConst.py -config configDir/BusTracker_QL_configFile.txt
#python CF_SVD_selOpConst.py -config BusTracker_configFile.txt
...
#python LSTM_RNN_Parallel_selOpConst.py -config configDir/BusTracker_RNN_sustenance_configFile.txt
