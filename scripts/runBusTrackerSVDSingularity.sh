...
python CF_SVD_selOpConst.py -config configDir/BusTracker_SVD_singularity_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_SVD_singularity_configFile.txt
