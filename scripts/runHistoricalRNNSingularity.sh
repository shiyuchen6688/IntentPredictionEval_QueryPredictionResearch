...
python LSTM_RNN_Parallel.py -config configDir/MINC_Historical_RNN_singularity_configFile.txt
python CreateSQLLogs.py -config configDir/MINC_Historical_RNN_singularity_configFile.txt
