...
python LSTM_RNN_Parallel_selOpConst.py -config configDir/BusTracker_Historical_RNN_singularity_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_Historical_RNN_singularity_configFile.txt
