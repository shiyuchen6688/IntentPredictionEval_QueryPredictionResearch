...
python CF_SVD_selOpConst.py -config configDir/BusTracker_SVD_trainTest_sustenance_0.8_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_SVD_trainTest_sustenance_0.8_configFile.txt
