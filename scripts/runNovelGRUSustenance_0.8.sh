...
python LSTM_RNN_Parallel_selOpConst.py -config configDir/MINC_Novel_GRU_trainTest_sustenance_0.8_configFile.txt
python CreateSQLLogs.py -config configDir/MINC_Novel_GRU_trainTest_sustenance_0.8_configFile.txt
