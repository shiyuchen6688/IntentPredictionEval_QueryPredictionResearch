...
python CFCosineSim_Parallel.py -config configDir/MINC_CF_COSINESIM_singularity_configFile.txt
python CreateSQLLogs.py -config configDir/MINC_CF_COSINESIM_singularity_configFile.txt
