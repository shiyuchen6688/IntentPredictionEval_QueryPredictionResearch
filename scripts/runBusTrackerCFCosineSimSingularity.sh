...
python CFCosineSim_Parallel.py -config configDir/BusTracker_CF_COSINESIM_singularity_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_CF_COSINESIM_singularity_configFile.txt
