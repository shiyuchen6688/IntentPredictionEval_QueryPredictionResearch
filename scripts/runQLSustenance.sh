...
python CreateSQLLogs.py -config configDir/MINC_QL_sustenance_configFile.txt
...
#python CFCosineSim_Parallel_selOpConst.py -config configDir/MINC_CF_COSINESIM_sustenance_configFile.txt
