#!/bin/sh
python QLearning_selOpConst.py -config configDir/BusTracker_QL_trainTest_sustenance_0.8_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_QL_trainTest_sustenance_0.8_configFile.txt
