...
python CFCosineSim_Parallel.py -config configDir/BusTracker_CF_COSINESIM_trainTest_sustenance_0.8_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_CF_COSINESIM_trainTest_sustenance_0.8_configFile.txt
