...
python LSTM_RNN_Parallel_selOpConst.py -config configDir/BusTracker_Novel_RNN_trainTest_sustenance_0.8_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_Novel_RNN_trainTest_sustenance_0.8_configFile.txt
