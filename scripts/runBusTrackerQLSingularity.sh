#!/bin/sh
python QLearning_selOpConst.py -config configDir/BusTracker_QL_singularity_configFile.txt
python CreateSQLLogs.py -config configDir/BusTracker_QL_singularity_configFile.txt
