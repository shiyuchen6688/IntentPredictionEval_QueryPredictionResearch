...
python LSTM_RNN_Parallel.py -config configDir/MINC_Historical_RNN_trainTest_sustenance_0.8_configFile.txt
python CreateSQLLogs.py -config configDir/MINC_Historical_RNN_trainTest_sustenance_0.8_configFile.txt
